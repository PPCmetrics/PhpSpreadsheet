...
class Chart extends WriterPart
{
    ...
    private function writeTitle(XMLWriter $objWriter, ?Title $title = null): void
    {
        ...
        if ($title->getOrientation() !== null) {
            $objWriter->writeAttribute('algn', $title->getOrientation());
        } else {
    ...
    private function writePlotArea(XMLWriter $objWriter, PlotArea $plotArea, ?Title $xAxisLabel = null, ?Title $yAxisLabel = null, ?Axis $xAxis = null, ?Axis $yAxis = null, ?GridLines $majorGridlines = null, ?GridLines $minorGridlines = null): void
    {
        ...
        foreach ($chartTypes as $chartType) {
            ...
            for ($i = 0; $i < $groupCount; ++$i) {
                ...
                if ($groupType == $chartType) {
                    ...
                    $this->writePlotGroup($plotGroup, $chartType, $objWriter, $catIsMultiLevelSeries, $valIsMultiLevelSeries, $plotGroupingType, $plotArea);
                }
            }
        ...
        if (($chartType !== DataSeries::TYPE_PIECHART) && ($chartType !== DataSeries::TYPE_PIECHART_3D) && ($chartType !== DataSeries::TYPE_DONUTCHART)) {
            if ($chartType === DataSeries::TYPE_BUBBLECHART) {
                $this->writeValueAxis($objWriter, $xAxisLabel, $chartType, $id1, $id2, $catIsMultiLevelSeries, $xAxis, $majorGridlines, $minorGridlines, true);
            } else {
        ...
        if ($plotArea->getHasBorder()) {//PPCmetrics
            $objWriter->startElement('c:spPr');
            $objWriter->startElement('a:ln');
            $objWriter->startElement('a:solidFill');
            $objWriter->startElement('a:srgbClr');
            $objWriter->writeAttribute('val', "A0A0A0");
            $objWriter->endElement();
            $objWriter->endElement();
            $objWriter->endElement();
            $objWriter->endElement();
    ...
    private function writeDataLabels(XMLWriter $objWriter, ?Layout $chartLayout = null): void
    {
        ...
        $this->writeDataLabelSettings($objWriter, $chartLayout);
        $objWriter->endElement();
    }

    private function writeDataLabelSettings(XMLWriter $objWriter, ?Layout $chartLayout = null): void
    {
    ...
    private function writeValueAxis(XMLWriter $objWriter, ?Title $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, Axis $xAxis, GridLines $majorGridlines, GridLines $minorGridlines, bool $reverse = false): void
    {
        ...
        if (($reverse ? $id1 : $id2) > 0) {
            $objWriter->startElement('c:axId');
            $objWriter->writeAttribute('val', ($reverse ? $id1 : $id2));
            $objWriter->endElement();
        }
        ...
        if ($xAxis->getFontBold() || $xAxis->getFontFamily() || $xAxis->getFontSize()) {
            $objWriter->startElement('c:txPr');
            $objWriter->startElement('a:bodyPr');
            $objWriter->endElement();
            $objWriter->startElement('a:lstStyle');
            ...
            $objWriter->startElement('a:pPr');
            $objWriter->startElement('a:defRPr');
            if ($xAxis->getFontSize()) {
                $objWriter->writeAttribute('sz', $xAxis->getFontSize());
            }
            if ($xAxis->getFontBold()) {
                $objWriter->writeAttribute('b', 1);
            }
            if ($xAxis->getFontFamily()) {
                $objWriter->startElement('a:latin');
                $objWriter->writeAttribute('typeface', $xAxis->getFontFamily());
                $objWriter->endElement();
        ...
        if (($reverse ? $id2 : $id1) > 0) {
            $objWriter->startElement('c:crossAx');
            $objWriter->writeAttribute('val', ($reverse ? $id2 : $id1));
            $objWriter->endElement();
     ...
     */
    private function writePlotGroup(?DataSeries $plotGroup, string $groupType, XMLWriter $objWriter, &$catIsMultiLevelSeries, &$valIsMultiLevelSeries, &$plotGroupingType, $plotArea): void
    {
        if ($plotGroup === null) {
            return;
        }
        ...
        if (($groupType !== DataSeries::TYPE_RADARCHART) && ($groupType !== DataSeries::TYPE_STOCKCHART)) {
            if ($groupType !== DataSeries::TYPE_LINECHART &&  $groupType !== DataSeries::TYPE_BUBBLECHART) {
        ...
        foreach ($plotSeriesOrder as $plotSeriesIdx => $plotSeriesRef) {
            ...
            if ($groupType == DataSeries::TYPE_BUBBLECHART) {
                ...
                if ($fillColorValues !== null) {
                    ...
                    $objWriter->startElement('a:solidFill');
                    $objWriter->startElement('a:srgbClr');
                    $objWriter->writeAttribute('val', substr($fillColorValues,-6));
                    if (strlen($fillColorValues)==8) {
                        $objWriter->startElement('a:alpha');
                        $objWriter->writeAttribute('val', intval(100000*(hexdec(substr($fillColorValues,0,2))/255.0)));
                        $objWriter->endElement();
                    }
                    $objWriter->endElement();
                    $objWriter->endElement();
            ...
            if ($plotSeriesValues && $groupType === DataSeries::TYPE_BUBBLECHART) { //PPCmetrics
                $objWriter->startElement('c:dLbls');
                $idx = 0;
                foreach ($plotSeriesValues->getDataLabels() as $dlbl) {
                    ...
                    $objWriter->writeAttribute('val', $dlbl[0]);
                    $objWriter->endElement();
                    $objWriter->startElement('c:y');
                    $objWriter->writeAttribute('val', $dlbl[1]);
                    $objWriter->endElement();
                    $objWriter->endElement();
                    $objWriter->endElement();
                    ...
                    $objWriter->writeAttribute('val', 'ctr');
                    $objWriter->endElement();
                    $this->writeDataLabelSettings($objWriter, $plotArea->getLayout());
                    $objWriter->endElement();
                    $idx++;
                }
                if (($dlbl[2]??null)) {
                    ...
                    $objWriter->writeElement('a:spAutoFit');
                    $objWriter->endElement();
    ...
    private function writeBubbles(?DataSeriesValues $plotSeriesValues, XMLWriter $objWriter): void
    {
        ...
        $objWriter->startElement('c:f');
        $objWriter->writeRawData($plotSeriesValues->getDataBubbleSource());
        $objWriter->endElement();
        ...
        $dataBubbleSizes = $plotSeriesValues->getDataBubbleSizes();
        if (!empty($dataBubbleSizes)) {
            if (is_array($dataBubbleSizes)) {
                foreach ($dataBubbleSizes as $plotSeriesKey => $plotSeriesBubbleSize) {
                    $objWriter->startElement('c:pt');
                    $objWriter->writeAttribute('idx', $plotSeriesKey);
                    $objWriter->startElement('c:v');
                    $objWriter->writeRawData($plotSeriesBubbleSize);
                    $objWriter->endElement();
                    $objWriter->endElement();
                }
            }
